...
class PeripheralTestOperations {
  ...
  PeripheralTestOperations(this.bleManager, this.peripheral, this.log, this.logError);
  ...
  Future<void> cancelTransaction() async {
    await _runWithErrorHandling(() async {
      ...
      peripheral.discoverAllServicesAndCharacteristics(transactionId: "test").catchError((error) {
  ...
  Future<void> discovery() async => await _runWithErrorHandling(() async {
        ...
        await services.forEach((service) async {
          log("Found service \n${service.uuid}");
          ...
          List<Characteristic> characteristicFromPeripheral = await peripheral.characteristics(service.uuid);
          characteristicFromPeripheral.forEach((characteristic) => log("Found characteristic \n ${characteristic.uuid}"));
        });
  ...
  Future<void> readCharacteristicForPeripheral() async {
    await _runWithErrorHandling(() async {
      ...
      CharacteristicWithValue readValue =
          await peripheral.readCharacteristic(SensorTagTemperatureUuids.temperatureService, SensorTagTemperatureUuids.temperatureDataCharacteristic);
  ...
  Future<void> readCharacteristicForService() async {
    await _runWithErrorHandling(() async {
      log("Reading temperature config");
      Service service =
          await peripheral.services().then((services) => services.firstWhere((service) => service.uuid == SensorTagTemperatureUuids.temperatureService.toLowerCase()));
      CharacteristicWithValue readValue = await service.readCharacteristic(SensorTagTemperatureUuids.temperatureDataCharacteristic);
      log("Temperature config value: \n${_convertToTemperature(readValue.value)}C");
    });
  }
  ...
  Future<void> readCharacteristic() async {
    await _runWithErrorHandling(() async {
      ...
      List<Characteristic> characteristics = await service.characteristics();
      Characteristic characteristic = characteristics.firstWhere((characteristic) => characteristic.uuid == SensorTagTemperatureUuids.temperatureDataCharacteristic.toLowerCase());
  ...
  Future<void> writeCharacteristicForPeripheral() async {
    await _runWithErrorHandling(() async {
      Uint8List currentValue = await peripheral
          .readCharacteristic(SensorTagTemperatureUuids.temperatureService, SensorTagTemperatureUuids.temperatureConfigCharacteristic)
      ...
      await peripheral.writeCharacteristic(
          SensorTagTemperatureUuids.temperatureService, SensorTagTemperatureUuids.temperatureConfigCharacteristic, Uint8List.fromList([valueToSave]), false);
  ...
  Future<void> writeCharacteristicForService() async {
    await _runWithErrorHandling(() async {
      ...
      Uint8List currentValue = await service.readCharacteristic(SensorTagTemperatureUuids.temperatureConfigCharacteristic).then((characteristic) => characteristic.value);
  ...
  Future<void> writeCharacteristic() async {
    await _runWithErrorHandling(() async {
      ...
      Characteristic characteristic =
          characteristics.firstWhere((characteristic) => characteristic.uuid == SensorTagTemperatureUuids.temperatureConfigCharacteristic.toLowerCase());
  ...
  Future<void> monitorCharacteristicForPeripheral() async {
    await _runWithErrorHandling(() async {
      ...
      _startMonitoringTemperature(
          peripheral
              .monitorCharacteristic(SensorTagTemperatureUuids.temperatureService, SensorTagTemperatureUuids.temperatureDataCharacteristic, transactionId: "ignitionOn")
  ...
  Future<void> monitorCharacteristic() async {
    await _runWithErrorHandling(() async {
      ...
      _startMonitoringTemperature(characteristic.monitor(transactionId: "monitor"), log);
    });
  }
  ...
  Future<void> readWriteMonitorCharacteristicForPeripheral() async {
    await _runWithErrorHandling(() async {
      ...
      _startMonitoringTemperature(
        peripheral
            .monitorCharacteristic(SensorTagTemperatureUuids.temperatureService, SensorTagTemperatureUuids.temperatureDataCharacteristic, transactionId: "1")
            .map((characteristic) => characteristic.value),
        log,
      );
      log("Turning off temperature update");
      await peripheral.writeCharacteristic(SensorTagTemperatureUuids.temperatureService, SensorTagTemperatureUuids.temperatureConfigCharacteristic, Uint8List.fromList([0]), false);
      ...
      await peripheral.writeCharacteristic(SensorTagTemperatureUuids.temperatureService, SensorTagTemperatureUuids.temperatureConfigCharacteristic, Uint8List.fromList([1]), false);
      ...
      await Future.delayed(Duration(seconds: 1));
      log("Reading temperature");
      readValue = await peripheral.readCharacteristic(SensorTagTemperatureUuids.temperatureService, SensorTagTemperatureUuids.temperatureDataCharacteristic);
      log("Read temperature value ${_convertToTemperature(readValue.value)}C");
  ...
  Future<void> readWriteMonitorCharacteristicForService() async {
    await _runWithErrorHandling(() async {
      ...
      log("Start monitoring temperature");
      _startMonitoringTemperature(
        service.monitorCharacteristic(SensorTagTemperatureUuids.temperatureDataCharacteristic, transactionId: "2").map((characteristic) => characteristic.value),
        log,
      );
      ...
      CharacteristicWithValue dataCharacteristic = await service.readCharacteristic(SensorTagTemperatureUuids.temperatureDataCharacteristic);
      log("Read temperature value ${_convertToTemperature(dataCharacteristic.value)}C");

      log("Turning on temperature update");
      await service.writeCharacteristic(SensorTagTemperatureUuids.temperatureConfigCharacteristic, Uint8List.fromList([1]), false);
      log("Turned on temperature update");
      ...
      log("Reading temperature value");
      dataCharacteristic = await service.readCharacteristic(SensorTagTemperatureUuids.temperatureDataCharacteristic);
      log("Read temperature value ${_convertToTemperature(dataCharacteristic.value)}C");
      log("Canceling temperature monitoring");
  ...
  Future<void> readWriteMonitorCharacteristic() async {
    await _runWithErrorHandling(() async {
      ...
      Characteristic dataCharacteristic =
          characteristics.firstWhere((characteristic) => characteristic.uuid == SensorTagTemperatureUuids.temperatureDataCharacteristic.toLowerCase());
  ...
  Future<void> fetchConnectedDevice() async {
    await _runWithErrorHandling(() async {
      ...
      peripherals = await bleManager.connectedPeripherals([SensorTagTemperatureUuids.temperatureService]);
      peripherals.forEach((peripheral) => log("\t${peripheral.toString()}"));
      log("Device fetched");
    });
  }
  ...
  Future<void> readDescriptorForPeripheral() async => _runWithErrorHandling(() async {
  ...
  Future<void> readDescriptorForService() async => _runWithErrorHandling(() async {
        log("READ DESCRIPTOR FOR SERVICE");

        log("Fetching service");
        List<Service> services = await peripheral.services();
        Service chosenService = services.firstWhere((elem) => elem.uuid == SensorTagTemperatureUuids.temperatureService.toLowerCase());
  ...
  Future<void> readDescriptorForCharacteristic() async => _runWithErrorHandling(() async {
  ...
  Future<void> readDescriptor() async => _runWithErrorHandling(() async {
        ...
        Descriptor chosenDescriptor = descriptors.firstWhere((elem) => elem.uuid == SensorTagTemperatureUuids.clientCharacteristicConfigurationDescriptor);
  ...
  Future<void> writeDescriptorForPeripheral({bool enable = false}) async => _runWithErrorHandling(() async {
  ...
  Future<void> writeDescriptorForService({bool enable = false}) async => _runWithErrorHandling(() async {
  ...
  Future<void> writeDescriptorForCharacteristic({bool enable = false}) async => _runWithErrorHandling(() async {
  ...
  Future<void> writeDescriptor({bool enable = false}) async => _runWithErrorHandling(() async {
  ...
  Future<void> readWriteDescriptorForPeripheral() async => _runWithErrorHandling(
        () async {
  ...
  Future<void> readWriteDescriptorForCharacteristic() async => _runWithErrorHandling(
        () async {
